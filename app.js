...
const SUPABASE_URL = 'https://TUO_SUPABASE_URL.supabase.co'; // <-- Inserisci qui il tuo URL Supabase
const SUPABASE_KEY = 'TUO_SUPABASE_ANON_KEY'; // <-- Inserisci qui la tua anon key
